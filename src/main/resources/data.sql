...
insert into guest(id, name) values(null, 'Felipe Ministerio');
...
insert
    ...
    into
        ...
        (id, start_date_time, end_date_time, tennis_court_id)
    values
        (null, '2021-05-16T20:00:00.0', '2021-05-16T21:00:00.0', 2);
    ...
    into
        ...
        (id, start_date_time, end_date_time, tennis_court_id)
    values
        (null, '2021-05-20T12:00:00.0', '2021-05-20T13:00:00.0', 2);
